...
| DistanceResetEvent                                  | `Reset Statistic` | Distance moved after reset            |
| AverageSpeedResetEvent                              | `Reset Statistic` | Average speed after rest              |
| DrivenTimeResetEvent                                | `Reset Statistic` | Driving time after reset              |
| LiquidConsumptionEvent                              | `Reset Statistic` | Liquid consumption after rest         |
| DistanceZEResetEvent                                | `Reset Statistic` |                                       |
| DistanceStartEvent                                  | `Start Statistic` | Distance moved after start            |
| AverageSpeedStartEvent                              | `Start Statistic` | Average speed after start             |
| DrivenTimeStartEvent                                | `Start Statistic` | Driving time after start              |
| LiquidConsumptionStartEvent                         | `Start Statistic` | Liquid consumption after start        |
| DistanceZEStartEvent                                | `Start Statistic` |                                       |
