...
var file_protos_proto_rawDesc = []byte{
	...
	0x57, 0x45, 0x42, 0x10, 0x05, 0x42, 0x21, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x61, 0x69,
	0x6d, 0x6c, 0x65, 0x72, 0x2e, 0x6d, 0x62, 0x63, 0x61, 0x72, 0x6b, 0x69, 0x74, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_protos_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_protos_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_protos_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_protos_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_protos_proto_msgTypes[13].Exporter = func(v any, i int) any {
