...
func (x *ClientMessage) GetUnsubscribeRequest() *UnsubscribeRequest {
...
func (x *ClientMessage) GetAcknowledgeAssignedVehicles() *AcknowledgeAssignedVehicles {
...
type ClientMessage_UnsubscribeRequest struct {
	UnsubscribeRequest *UnsubscribeRequest `protobuf:"bytes,2,opt,name=unsubscribeRequest,proto3,oneof"`
}
...
type ClientMessage_AcknowledgeAssignedVehicles struct {
	AcknowledgeAssignedVehicles *AcknowledgeAssignedVehicles `protobuf:"bytes,23,opt,name=acknowledge_assigned_vehicles,json=acknowledgeAssignedVehicles,proto3,oneof"`
}
...
var file_client_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x74, 0x42, 0x21, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x61, 0x69, 0x6d, 0x6c,
...
var file_client_proto_goTypes = []any{
	...
	(*UnsubscribeRequest)(nil),                                  // 2: proto.UnsubscribeRequest
	...
	(*AcknowledgeAssignedVehicles)(nil),                         // 20: proto.AcknowledgeAssignedVehicles
}
